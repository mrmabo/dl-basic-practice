...
def build_dataloader():
    ...
    train_raw, temp_raw, _, temp_months = train_test_split(
        values, months, train_size=0.6, shuffle=False
    )
...
def main():
    ...
    for month, actual1, predication in zip(test_months, actual, pred):
        print(f"month={month} actual1={actual1:.1f} predication={predication:.1f}")
